  ...
  return (
    <SonnerToaster
      ...
      toastOptions={{
        classNames: {
          toast:
            'group toast rounded-2xl border font-body-sm text-[13px] shadow-xl group-[.toaster]:bg-white group-[.toaster]:text-slate-900 group-[.toaster]:border-rose-100 dark:group-[.toaster]:bg-[#0f1a2e] dark:group-[.toaster]:text-rose-50 dark:group-[.toaster]:border-rose-950/40',
          description: 'group-[.toast]:text-slate-500 dark:group-[.toast]:text-rose-300/70',
          actionButton: 'group-[.toast]:bg-[#f16b48] group-[.toast]:text-white group-[.toast]:rounded-xl',
